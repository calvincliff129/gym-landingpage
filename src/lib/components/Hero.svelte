...
<SectionWrapper id="hero">
  ...
  >
    <h2
      class="text-5xl sm:text-6xl md:text-7xl lg:text-8xl max-w-[1200px] mx-auto w-full text-center text-cursor"
    >
    ...
    >
      Less thinking & more dialog. We're the trainer in your pocket full of <span
        class="italic"
