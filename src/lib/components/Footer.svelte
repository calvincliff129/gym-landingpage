<footer class="py-16 sm:py-20 md:py-24 px-4 md:px-8">
  ...
  >
    ...
    <div class="flex flex-col gap-4">
      ...
      <a href="/" class="cursor-pointer hover:text-indigo-400 duration-200">
        Contact Us</a
      >
    </div>
    <div class="flex flex-col gap-4">
      <p class="font-semibold poppins text-base sm:text-lg">Research</p>
      <a href="/" class="cursor-pointer hover:text-indigo-400 duration-200">
        Read the science</a
      >
    </div>
    <div class="flex flex-col gap-4">
      <p class="font-semibold poppins text-base sm:text-lg">Follow Us</p>
      <a href="/" class="cursor-pointer hover:text-indigo-400 duration-200">
