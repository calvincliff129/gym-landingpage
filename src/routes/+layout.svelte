...
{#if $openModal}
  <div
    class="fixed top-0 left-0 w-screen h-screen border-b bg-white z-50 flex flex-col gap-8 py-5 px-8 md:hidden"
  >
    ...
    <div class="flex flex-col gap-4 flex-1">
      ...
      >
        <p class="duration-200 group-hover:pl-2 poppins text-3xl font-semibold">
          Products <i class="fa-solid fa-chevron-right text-xl pl-4"></i>
        </p>
      </button>
      <button
